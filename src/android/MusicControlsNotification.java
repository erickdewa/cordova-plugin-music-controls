...
public class MusicControlsNotification {
    ...
    // Toggle the seekTo update elapsed
    public void updateElapsed(int elapsed) {
        this.infos.elapsed = Integer.toString(elapsed);
        this.createBuilder();
        Notification noti = this.notificationBuilder.build();
        this.notificationManager.notify(this.notificationID, noti);
        this.onNotificationUpdated(noti);
    ...
    private void createBuilder() {
        ...
        if (infos.dismissable) {
            ...
            PendingIntent dismissPendingIntent = PendingIntent.getBroadcast(context, 1, dismissIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
		...
		// Set Seek To
        double doubleValDuration = Double.parseDouble(infos.duration);
        double doubleValElapsed = Double.parseDouble(infos.elapsed);
        builder.setProgress((int) doubleValDuration, (int) doubleValElapsed, false);
        ...
        PendingIntent resultPendingIntent = PendingIntent.getActivity(context, 0, resultIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
        ...
        if (infos.hasPrev) {
            ...
            PendingIntent previousPendingIntent = PendingIntent.getBroadcast(context, 1, previousIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
        ...
        if (infos.isPlaying) {
            ...
            PendingIntent pausePendingIntent = PendingIntent.getBroadcast(context, 1, pauseIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
            ...
            PendingIntent playPendingIntent = PendingIntent.getBroadcast(context, 1, playIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
        ...
        if (infos.hasNext) {
            ...
            PendingIntent nextPendingIntent = PendingIntent.getBroadcast(context, 1, nextIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
        ...
        if (infos.hasClose) {
            ...
            PendingIntent destroyPendingIntent = PendingIntent.getBroadcast(context, 1, destroyIntent, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? (Build.VERSION.SDK_INT >= 34 ? PendingIntent.FLAG_IMMUTABLE : PendingIntent.FLAG_MUTABLE) : 0);
